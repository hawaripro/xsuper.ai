...
class ImageJob extends Model
{
    protected $hidden = [
        ...
        'routing_identity', 'dedup_key', 'payload_fingerprint', 'batch_key',
        'provider_result_urls', 'provider_result_data',
    ];
    ...
    protected function casts(): array
    {
        return [
            ...
            'provider_result_urls' => 'array', 'provider_result_data' => 'array',
        ];
    }
