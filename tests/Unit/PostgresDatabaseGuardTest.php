...
class PostgresDatabaseGuardTest extends TestCase
{
    ...
    public static function unsafeTargets(): array
    {
        return [
            ...
            'primary PostgreSQL database' => ['testing', 'pgsql', ['database' => 'xsuper_db']],
            'non-loopback host' => ['testing', 'pgsql', ['host' => '192.0.2.1']],
            'different local port' => ['testing', 'pgsql', ['port' => '5432']],
            'primary PostgreSQL role' => ['testing', 'pgsql', ['username' => 'xsuper_local']],
            'inherited database password' => ['testing', 'pgsql', ['password' => 'unrelated-password']],
            'URL overrides approved fields' => ['testing', 'pgsql', ['url' => 'pgsql://127.0.0.1/xsuper_db']],
            'read connection redirects queries' => ['testing', 'pgsql', ['read' => ['database' => 'xsuper_db']]],
            'write connection redirects migrations' => ['testing', 'pgsql', ['write' => ['database' => 'xsuper_db']]],
            'connector database override' => ['testing', 'pgsql', ['connect_via_database' => 'xsuper_db']],
    ...
    {
        $identity = [
            'database_name' => 'xsuper_pg_test',
            'database_user' => 'xsuper_pg_test',
            'session_user' => 'xsuper_pg_test',
    ...
    {
        return [
            'connected to primary database' => [['database_name' => 'xsuper_db']],
            'connected as primary role' => [['database_user' => 'xsuper_local']],
            'primary role switched to test role' => [['session_user' => 'xsuper_local']],
