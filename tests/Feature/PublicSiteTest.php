...
class PublicSiteTest extends TestCase
{
    ...
    public function test_home_preserves_indexable_identity_and_accurate_offers_and_faq_schema(): void
    {
        ...
        $this->assertSame('https://xsuper.dev/xsuper-logo.png', $html->evaluate('string(//meta[@property="og:image"]/@content)'));
        $this->assertSame('/xsuper-mark.png', $html->evaluate('string(//link[@rel="icon"]/@href)'));
