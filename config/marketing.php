...
return [
    ...
    'hero' => [
        'headline' => "Satu ruang.\nSemua kemungkinan.",
        'description' => 'Platform AI untuk berkarya, belajar, dan membangun. Dari percakapan pertama sampai produk berikutnya—semuanya berawal di XSuper.ai.',
    ...
    'faqs' => [
        ['question' => 'Apa itu XSuper.ai?', 'answer' => 'XSuper.ai adalah platform untuk menggunakan pilihan model AI premium dalam satu akun pribadi. Kamu dapat bekerja lewat Chat AI dan menggunakan akses API sesuai paket serta izin akun. XSuper.ai menyediakan pengalaman layanannya; model pihak ketiga tetap milik pembuat masing-masing.'],
