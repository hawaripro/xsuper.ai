...
<main id="main-content">
        ...
        <div class="container hero-grid">
            ...
            <div class="orbit-stage" data-orbit-stage aria-label="{{ __('Pilihan model AI dalam platform XSuper.ai') }}">
                ...
                <div class="orbit-system">
                    ...
                    <div class="orbit-core"><div class="core-ring" aria-hidden="true"></div><img src="/xsuper-icon.png" srcset="/xsuper-icon.png 256w, /xsuper-icon.png 512w" sizes="140px" width="140" height="140" alt="XSuper.ai" fetchpriority="high"><span>{{ __('Pusat kreativitasmu.') }}</span></div>
  ...
  return Object.groupBy(notes, note =&gt; note.project);
            ...
            <div class="workspace-support"><span>@include('public.partials.icon', ['name' => 'chat']) {{ __('Riwayat percakapan') }}</span><span>@include('public.partials.icon', ['name' => 'file']) {{ __('Lampiran gambar & dokumen') }}</span><span><img class="feature-mark" src="/xsuper-icon.png" width="18" height="18" alt="" loading="lazy"> {{ __('Pilihan model dalam satu ruang') }}</span><a class="text-link" href="/chat">{{ __('Masuk ke workspace') }} @include('public.partials.icon', ['name' => 'external'])</a></div>
        </div>
    </section>
...
with urllib.request.urlopen(request) as response:
    ...
    <section class="closing-section" aria-labelledby="closing-title" data-motion-zone>
        <div class="closing-orbit orbit-close-one" aria-hidden="true"></div><div class="closing-orbit orbit-close-two" aria-hidden="true"></div><div class="container closing-content" data-reveal="line"><img src="/xsuper-icon.png" width="58" height="58" alt="XSuper.ai" loading="lazy"><h2 id="closing-title">{{ __('Idemu terlalu bagus') }}<br>{{ __('untuk') }} <span>{{ __('berhenti di kepala.') }}</span></h2><p>{{ __('Buka ruang untuk kemungkinan berikutnya.') }}</p><div class="closing-actions"><a href="{{ $localeUrl('/pricing') }}" class="button button-light">{{ __('Lihat paket XSuper.ai') }} @include('public.partials.icon', ['name' => 'arrow'])</a><a href="/chat" class="text-link">{{ __('Sudah punya akun? Buka workspace') }} @include('public.partials.icon', ['name' => 'external'])</a></div></div>
    </section>
</main>
@if($recentPurchases !== [])
