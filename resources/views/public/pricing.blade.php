...
<main id="main-content" class="pricing-page">
        ...
        <div class="container pricing-hero-grid">
            ...
            <div class="orbit-stage pricing-orbit-stage" data-orbit-stage aria-label="{{ __('Enam paket XSuper.ai dalam orbit langganan') }}">
                ...
                <div class="orbit-system">
                    ...
                    <div class="orbit-core"><div class="core-ring" aria-hidden="true"></div><img src="/xsuper-icon.png" width="140" height="140" alt="XSuper.ai"><span>{{ __('Pilih ritmemu.') }}</span></div>
    ...
    <section class="pricing-final" data-motion-zone><div class="closing-orbit orbit-close-one" aria-hidden="true"></div><div class="closing-orbit orbit-close-two" aria-hidden="true"></div><div class="container" data-reveal="line"><img src="/xsuper-icon.png" width="54" height="54" alt="XSuper.ai" loading="lazy"><h2>{{ __('Mulai kecil.') }}<br><span>{{ __('Biarkan idemu tumbuh.') }}</span></h2><p>{{ __('Belum yakin paket mana? Ceritakan cara kerjamu—tim XSuper.ai membantu memilih tanpa memaksakan durasi.') }}</p><div><a class="button button-light" href="https://wa.me/{{ $site['support']['phone'] }}">{{ __('Bicara dengan tim') }} @include('public.partials.icon', ['name' => 'external'])</a><a class="text-link" href="{{ $localeUrl('/refund-policy') }}">{{ __('Baca Refund Policy') }} @include('public.partials.icon', ['name' => 'arrow'])</a></div></div></section>
</main>
@endsection
