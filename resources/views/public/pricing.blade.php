...
<main id="main-content" class="pricing-page">
    <section class="pricing-hero" aria-labelledby="pricing-page-title" data-motion-zone>
        <div class="container pricing-hero-grid">
            <div class="pricing-hero-copy" data-reveal="stagger">
                ...
                <p data-reveal-item>{{ __('Enam durasi, satu ruang UltrAI. Mulai satu hari untuk mencoba atau pilih ritme yang menemani pekerjaanmu lebih lama.') }}</p>
            ...
            <div class="orbit-stage pricing-orbit-stage" data-orbit-stage aria-label="{{ __('Enam paket UltrAI dalam orbit langganan') }}">
                ...
                <div class="orbit-system">
                    ...
                    <div class="orbit-core"><div class="core-ring" aria-hidden="true"></div><img src="/brands/ultrai/mark-256.webp" width="140" height="140" alt="UltrAI"><span>{{ __('Pilih ritmemu.') }}</span></div>
    ...
    <section class="pricing-final" data-motion-zone><div class="closing-orbit orbit-close-one" aria-hidden="true"></div><div class="closing-orbit orbit-close-two" aria-hidden="true"></div><div class="container" data-reveal="line"><img src="/brands/ultrai/mark-96.webp" width="54" height="54" alt="UltrAI" loading="lazy"><h2>{{ __('Mulai kecil.') }}<br><span>{{ __('Biarkan idemu tumbuh.') }}</span></h2><p>{{ __('Belum yakin paket mana? Ceritakan cara kerjamu—tim UltrAI membantu memilih tanpa memaksakan durasi.') }}</p><div><a class="button button-light" href="https://wa.me/{{ $site['support']['phone'] }}">{{ __('Bicara dengan tim') }} @include('public.partials.icon', ['name' => 'external'])</a><a class="text-link" href="{{ $localeUrl('/refund-policy') }}">{{ __('Baca Refund Policy') }} @include('public.partials.icon', ['name' => 'arrow'])</a></div></div></section>
</main>
@endsection
