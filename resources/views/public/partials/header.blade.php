...
<header class="site-header">
    <div class="container header-inner">
        <a href="{{ $localeUrl('/') }}" class="brand" aria-label="{{ __('XSuper.ai, beranda') }}">
            <img class="brand-logo brand-logo-light" src="/xsuper-logo-horizontal-v2.png" width="151" height="32" alt="{{ __('Logo XSuper.ai') }}" fetchpriority="high">
            <img class="brand-logo brand-logo-dark" src="/xsuper-logo-horizontal-white-v2.png" width="151" height="32" alt="" aria-hidden="true" fetchpriority="high">
        </a>
