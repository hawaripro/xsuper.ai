    ...
    return (
        <section id="pricing" className="relative py-20 md:py-28 overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto px-4 md:px-6">
                ...
                {/* Plans grid */}
                {/* ============================================
                    Plans — horizontal marquee carousel.
                    Desktop: infinite auto-scroll with hover-pause.
                    Mobile: same marquee, touch-pannable.
                    Cards are duplicated twice for seamless loop.
                   ============================================ */}
