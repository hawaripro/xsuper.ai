...
export default function Features() {
    return (
        <section id="why-ultrai" className="relative py-16 md:py-20 overflow-hidden">
            ...
            <div className="relative max-w-5xl mx-auto px-4 md:px-6">
                ...
                <div className="grid md:grid-cols-2 gap-5 lg:gap-6">
                    ...
                    >
                        ...
                        <div className="relative grid md:grid-cols-2 gap-0">
                            ...
                            <div className="p-5 lg:p-6 border-b md:border-b-0 md:border-r border-gray-200/70">
                                <div className="inline-flex items-center justify-center w-7 h-7 rounded-xl bg-gradient-to-br from-red-500 to-red-600 text-white shadow-[0_10px_24px_-6px_rgba(239,68,68,0.45)] ring-4 ring-red-500/20 mb-5 mx-auto group-hover:scale-110 group-hover:rotate-3 transition-all">
                            ...
                            <div className="p-5 lg:p-6">
                                <div className="inline-flex items-center justify-center w-7 h-7 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-500 text-white shadow-[0_10px_24px_-6px_rgba(16,185,129,0.45)] ring-4 ring-emerald-500/20 mb-5 mx-auto group-hover:scale-110 group-hover:rotate-3 transition-all">
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    {/* ===== Card 2: 50+ Models ===== */}
                    <div
                        className="relative overflow-hidden p-5 lg:p-6 rounded-3xl border border-gray-200/80 bg-white shadow-[0_12px_40px_-12px_rgba(15,23,42,0.12)] hover:shadow-[0_20px_48px_-12px_rgba(59,130,246,0.25)] hover:-translate-y-1 transition-all duration-300 group"
                    ...
                    >
                        ...
                        <div className="relative">
                            <div className="flex items-center justify-center gap-3 mb-5">
                                <div className="w-7 h-7 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-500 text-white shadow-[0_10px_24px_-6px_rgba(59,130,246,0.45)] ring-4 ring-blue-500/20 flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all">
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <h3 className="text-base font-extrabold tracking-tight text-slate-900 mb-1.5 text-center">Semua Model AI Top</h3>
                            ...
                            <div className="grid grid-cols-3 gap-2.5">
                                {[
                                    ...
                                    >
                                        <LogoChip className="w-7 h-7 group-hover/item:scale-110 transition-transform duration-200">
                    ...
                    <div
                        className="relative overflow-hidden p-5 lg:p-6 rounded-3xl border border-gray-200/80 bg-white shadow-[0_12px_40px_-12px_rgba(15,23,42,0.12)] hover:shadow-[0_20px_48px_-12px_rgba(139,92,246,0.25)] hover:-translate-y-1 transition-all duration-300 group"
                    ...
                    >
                        ...
                        <div className="relative">
                            <div className="flex items-center justify-center gap-3 mb-5">
                                <div className="w-7 h-7 rounded-xl bg-gradient-to-br from-violet-500 to-purple-500 text-white shadow-[0_10px_24px_-6px_rgba(139,92,246,0.45)] ring-4 ring-violet-500/20 flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all">
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <h3 className="text-base font-extrabold tracking-tight text-slate-900 mb-1.5 text-center">Support API Key</h3>
                            <p className="text-slate-600 leading-relaxed text-center mb-5">
                    ...
                    {/* ===== Card 4: Refund ===== */}
                    <div
                        className="md:col-span-2 relative overflow-hidden p-5 lg:p-6 rounded-3xl border border-emerald-200/80 bg-gradient-to-br from-white via-emerald-50/30 to-white shadow-[0_12px_40px_-12px_rgba(15,23,42,0.12)] hover:shadow-[0_20px_48px_-12px_rgba(16,185,129,0.25)] hover:-translate-y-1 transition-all duration-300 group"
                    ...
                    >
                        ...
                        <div className="relative flex flex-col md:flex-row md:items-center gap-6">
                            ...
                            <div className="flex-1">
                                ...
                                <h3 className="text-lg font-extrabold tracking-tight text-slate-900 mb-1.5 text-center">Garansi Refund / Replace</h3>
