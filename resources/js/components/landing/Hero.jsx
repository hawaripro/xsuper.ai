    ...
    return (
        <section className="relative min-h-dvh flex items-center justify-center overflow-hidden">
            ...
            <div className="relative max-w-3xl mx-auto px-5 md:px-6 text-center">
                {/* Eyebrow */}
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/80 border border-red-200/80 backdrop-blur-sm text-red-600 text-[11px] font-bold uppercase tracking-[0.15em] mb-5 animate-fade-in-down shadow-[0_4px_16px_-4px_rgba(239,68,68,0.15)]">
                ...
                {/* Subtitle */}
                <p className="mt-4 text-sm md:text-base lg:text-lg text-slate-600 leading-relaxed max-w-xl mx-auto animate-fade-in-up" style={{ animationDelay: '80ms' }}>
                ...
                {/* CTA */}
                <div className="mt-6 flex flex-wrap justify-center gap-3 animate-fade-in-up" style={{ animationDelay: '140ms' }}>
                    <button
                ...
                {/* Trust badges */}
                <div className="mt-6 flex flex-wrap justify-center items-center gap-x-4 gap-y-2 text-[11px] text-slate-500 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                ...
                <div className="mt-8 flex items-center justify-center gap-3 md:gap-5 animate-fade-in-up" style={{ animationDelay: '280ms' }}>
                    {[
