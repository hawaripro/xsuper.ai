    ...
    return (
        <section className="relative min-h-dvh flex items-center justify-center overflow-hidden">
            ...
            <div className="relative max-w-4xl mx-auto px-4 md:px-6 text-center">
                ...
                {/* Subtitle */}
                <p className="mt-5 text-base md:text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '80ms' }}>
                ...
                {/* Trust badges */}
                <div className="mt-8 flex flex-wrap justify-center items-center gap-x-5 gap-y-2 text-xs text-slate-500 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
