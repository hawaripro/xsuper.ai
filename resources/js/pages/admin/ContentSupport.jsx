...
export default function ContentSupport() {
    ...
    const startContentEditor = block => {
        ...
        setContentEditor(block ? { ...block, draftText: JSON.stringify(draft, null, 2) } : { id: null, key: 'home.hero', locale: 'id', draftText: '{\n  \n}' });
    };
