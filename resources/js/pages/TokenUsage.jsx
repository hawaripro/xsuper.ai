                            ...
                            <ResponsiveContainer>
                                {chartType === 'area' ? (
                                    <AreaChart data={modelTimeline.data}>
                                        ...
                                        {modelTimeline.models.map((m, i) => (
                                            <Area key={m} type="monotone" dataKey={m} stackId="1" stroke={COLORS[i % COLORS.length]} fill={`url(#grad-${i})`} strokeWidth={2} animationDuration={1000} animationBegin={i * 100} />
                                        ))}
                                    </AreaChart>
                                ) : (
                            ...
                            <div style={{ width: '100%', height: 200 }}>
                                <ResponsiveContainer>
                                    <AreaChart data={stats?.timeline || []}>
                                        ...
                                        <Tooltip content={<CustomTooltip isDark={isDark} />} />
                                        <Area type="monotone" dataKey="tokens" name="Tokens" stroke="#10b981" fill="url(#gradTotal)" strokeWidth={2} animationDuration={1200} />
                                    </AreaChart>
                                </ResponsiveContainer>
                            </div>
                        </div>
                        ...
                        <div className="mb-4" style={{ width: '100%', height: 200 }}>
                            <ResponsiveContainer>
                                <AreaChart data={userStats.timeline || []}>
                                    ...
                                    <Tooltip content={<CustomTooltip isDark={isDark} />} />
                                    <Area type="monotone" dataKey="tokens" name="Tokens" stroke="#ef4444" fill="url(#gradUser)" strokeWidth={2} animationDuration={1000} />
                                </AreaChart>
                            </ResponsiveContainer>
                        </div>
